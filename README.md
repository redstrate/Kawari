...
Kawari currently supports patch **7.56h1** (2026.09.15.0000.0000). We only support the Windows client. If you're looking for a 1.x server, check out our sister project [Kodama](https://codeberg.org/redstrate/Kodama).
