...
Kawari currently supports patch **7.51** (2026.05.25.0000.0000). We only support the Global Windows client. If you're looking for a 1.x server, check out our sister project [Kodama](https://codeberg.org/redstrate/Kodama).
