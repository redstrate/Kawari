...
Kawari currently supports patch **7.50h1** (2026.05.01.0000.0000). We only support the Global Windows client. If you're looking for a FFXIV 1.x server, check out our sister project [Kodama](https://codeberg.org/redstrate/Kodama).
