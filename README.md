...
Kawari currently supports patch **7.40h2** (2025.12.23.0000.0000). Previously supported patches are provided as tags (e.g. `2025.02.27.0000.0000`). These may not function or build correctly, these tags are more like historical markers.
