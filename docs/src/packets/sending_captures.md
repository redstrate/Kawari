...
If you're asked to send a capture to someone, refer to this tutorial to ensure it's safely and securely.
...
Do *not* send your capture as a `.cfcap` file to anybody, including us. This is because packets can contain sensitive information you probably do not want to share, and saidfields [are enumerated by the Chronofoil Project here](https://github.com/ProjectChronofoil/Chronofoil.Plugin?tab=readme-ov-file#isnt-there-sensitive-stuff-in-those-packets).
