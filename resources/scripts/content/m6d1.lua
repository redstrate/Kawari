...
TIMELINE_WALL_ON = 2 -- Corresponds to wall1_on in bg/ex5/07_mid_m6/shared/for_bg/sgbg_m6d1_a0_gmc01.sgb
...
function onVariantVote(director, vote)
    if vote == 1 then
        director:map_effect(MAP_EFFECT_LEFT_ROUTE, TIMELINE_WALL_ON)
    elseif vote == 2 then
        director:map_effect(MAP_EFFECT_CENTER_ROUTE, TIMELINE_WALL_ON)
    elseif vote == 3 then
        director:map_effect(MAP_EFFECT_RIGHT_ROUTE, TIMELINE_WALL_ON)
    end
end
