...
function onReturn(scene, results, player)
    ...
    elseif scene == 2 then
        ...
        player:start_event(originating_npc, OPENING_GRIDANIA, EVENT_TYPE_NEST, 0)
        player:play_scene(originating_npc, OPENING_GRIDANIA, 30, HIDE_HOTBAR | NO_DEFAULT_CAMERA, {2})
        return
    elseif scene == 5 then
