...
impl WorldDatabase {
    ...
    pub fn find_player_data(
        ...
        {
            use super::models::*;
            use super::schema::character::dsl::*;
    ...
    pub fn create_player_data(
        ...
        diesel::insert_into(super::schema::character::table)
            .values(character)
        ...
        diesel::insert_into(super::schema::classjob::table)
            .values(classjob)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::customize::table)
            .values(customize)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::quest::table)
            .values(quest)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::aetheryte::table)
            .values(aetheryte)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::volatile::table)
            .values(volatile)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::inventory::table)
            .values(inventory)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::aether_current::table)
        ...
        diesel::insert_into(super::schema::companion::table)
            .values(companion)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::content::table)
            .values(content)
            .execute(&mut self.connection)
            .unwrap();
        ...
        diesel::insert_into(super::schema::unlock::table)
            .values(unlock)
            .execute(&mut self.connection)
            .unwrap();
    ...
    pub fn delete_character(&mut self, for_content_id: u64) {
        ...
        {
            use super::schema::companion::dsl::*;
        ...
        {
            use super::schema::aether_current::dsl::*;
        ...
        {
            use super::schema::inventory::dsl::*;
        ...
        {
            use super::schema::aetheryte::dsl::*;
        ...
        {
            use super::schema::customize::dsl::*;
    ...
    pub fn request_full_character_list(&mut self) -> String {
        ...
        if let Ok(users) = character
            .select(super::models::Character::as_select())
            .load(&mut self.connection)
        {
