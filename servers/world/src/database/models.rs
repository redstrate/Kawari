...
use kawari::{
    ...
    constants::{
        ...
        CHOCOBO_TAXI_STANDS_BITMASK_SIZE, COMPLETED_LEGACY_QUEST_BITMASK_SIZE,
        COMPLETED_LEVEQUEST_BITMASK_SIZE, COMPLETED_QUEST_BITMASK_SIZE,
        CRYSTALLINE_CONFLICT_ARRAY_SIZE, CUTSCENE_SEEN_BITMASK_SIZE, DUNGEON_ARRAY_SIZE,
        FRONTLINE_ARRAY_SIZE, GATHERED_GATHERING_ITEMS_BITMASK_SIZE, GLASSES_STYLES_BITMASK_SIZE,
        ...
        ORNAMENT_BITMASK_SIZE, RAID_ARRAY_SIZE, SPECIAL_CONTENT_ARRAY_SIZE,
        TITLE_UNLOCK_BITMASK_SIZE, TRIAL_ARRAY_SIZE, TRIPLE_TRIAD_CARDS_BITMASK_SIZE,
        UNLOCK_BITMASK_SIZE, UNLOCKED_MAP_MARKERS_BITMASK_SIZE,
    },
...
pub struct Quest {
    ...
    pub completed_legacy: Bitmask<COMPLETED_LEGACY_QUEST_BITMASK_SIZE>,
